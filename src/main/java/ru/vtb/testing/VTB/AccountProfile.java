...
public WebDriver driver;
    ...
    //private final By pageInformation = By.xpath("//a[@class=\"О счете\"][1]");
    ...
    private final By buttonInsurance = By.xpath("//*[text()=\"Оформить страховку\"]");
    ...
    private final By titleRekvAcc = By.xpath("//p[text()=\"Реквизиты счета • 3355\"]");
    ...
    private final By titleRekvCard = By.xpath("//p[text()=\"Реквизиты карты • 6071\"]");
